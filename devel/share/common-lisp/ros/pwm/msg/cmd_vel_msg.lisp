...
(cl:defmethod cl:initialize-instance :after ((m <cmd_vel_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'cmd_vel_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pwm-msg:<cmd_vel_msg> is deprecated: use pwm-msg:cmd_vel_msg instead.")))

(cl:ensure-generic-function 'pwm1-val :lambda-list '(m))
(cl:defmethod pwm1-val ((m <cmd_vel_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pwm-msg:pwm1-val is deprecated.  Use pwm-msg:pwm1 instead.")
  (pwm1 m))

(cl:ensure-generic-function 'pwm2-val :lambda-list '(m))
(cl:defmethod pwm2-val ((m <cmd_vel_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pwm-msg:pwm2-val is deprecated.  Use pwm-msg:pwm2 instead.")
  (pwm2 m))

(cl:ensure-generic-function 'pwm3-val :lambda-list '(m))
(cl:defmethod pwm3-val ((m <cmd_vel_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pwm-msg:pwm3-val is deprecated.  Use pwm-msg:pwm3 instead.")
  (pwm3 m))
