...
void interruptISR_PIN1(){

}

void interruptISR_PIN2(){

}

void interruptISR_PIN3(){

}

void interruptISR_PIN4(){
...
{  
  ...
  //interruptISR(PIN1,CHANGE,interruptISR_PIN1);
  //interruptISR(PIN2,CHANGE,interruptISR_PIN2);
  //interruptISR(PIN3,CHANGE,interruptISR_PIN3);
  //interruptISR(PIN4,CHANGE,interruptISR_PIN4);
